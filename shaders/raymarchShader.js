...
void _fetchBalls() {
  const float TEXEL_SIZE = 1.0 / ${glslFloat(STATE_TEXTURE_WIDTH)};
  _ballCenter0 = texture2D(stateTexture, vec2(0.5 * TEXEL_SIZE, 0.5)).xyz; _ballRadius0 = texture2D(stateTexture, vec2(1.5 * TEXEL_SIZE, 0.5)).w;
  _ballCenter1 = texture2D(stateTexture, vec2(3.5 * TEXEL_SIZE, 0.5)).xyz; _ballRadius1 = texture2D(stateTexture, vec2(4.5 * TEXEL_SIZE, 0.5)).w;
  _ballCenter2 = texture2D(stateTexture, vec2(6.5 * TEXEL_SIZE, 0.5)).xyz; _ballRadius2 = texture2D(stateTexture, vec2(7.5 * TEXEL_SIZE, 0.5)).w;
  _ballCenter3 = texture2D(stateTexture, vec2(9.5 * TEXEL_SIZE, 0.5)).xyz; _ballRadius3 = texture2D(stateTexture, vec2(10.5 * TEXEL_SIZE, 0.5)).w;
  _ballCenter4 = texture2D(stateTexture, vec2(12.5 * TEXEL_SIZE, 0.5)).xyz; _ballRadius4 = texture2D(stateTexture, vec2(13.5 * TEXEL_SIZE, 0.5)).w;
  _ballCenter5 = texture2D(stateTexture, vec2(15.5 * TEXEL_SIZE, 0.5)).xyz; _ballRadius5 = texture2D(stateTexture, vec2(16.5 * TEXEL_SIZE, 0.5)).w;
  _ballCenter6 = texture2D(stateTexture, vec2(18.5 * TEXEL_SIZE, 0.5)).xyz; _ballRadius6 = texture2D(stateTexture, vec2(19.5 * TEXEL_SIZE, 0.5)).w;
  _ballCenter7 = texture2D(stateTexture, vec2(21.5 * TEXEL_SIZE, 0.5)).xyz; _ballRadius7 = texture2D(stateTexture, vec2(22.5 * TEXEL_SIZE, 0.5)).w;
  _ballCenter8 = texture2D(stateTexture, vec2(24.5 * TEXEL_SIZE, 0.5)).xyz; _ballRadius8 = texture2D(stateTexture, vec2(25.5 * TEXEL_SIZE, 0.5)).w;
  _ballCenter9 = texture2D(stateTexture, vec2(27.5 * TEXEL_SIZE, 0.5)).xyz; _ballRadius9 = texture2D(stateTexture, vec2(28.5 * TEXEL_SIZE, 0.5)).w;
  _ballCenter10 = texture2D(stateTexture, vec2(30.5 * TEXEL_SIZE, 0.5)).xyz; _ballRadius10 = texture2D(stateTexture, vec2(31.5 * TEXEL_SIZE, 0.5)).w;
  _ballCenter11 = texture2D(stateTexture, vec2(33.5 * TEXEL_SIZE, 0.5)).xyz; _ballRadius11 = texture2D(stateTexture, vec2(34.5 * TEXEL_SIZE, 0.5)).w;
}
...
float _raymarch(vec3 rayOrigin, vec3 rayDirection) {
...
void main() {
  ...
  float hit = _raymarch(rayOrigin, rayDirection);
