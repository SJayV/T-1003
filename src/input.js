...
const INPUT_SPEED_THRESHOLD  = 0.20;  // min normalised speed to count as motion
const INPUT_PERSIST_FRAMES   = 2;     // consecutive motion frames before reporting
const INPUT_SENSITIVITY      = 20;    // amplification: thresholded diff → speed [0,1]
const INPUT_PIXEL_THRESHOLD  = 10;    // per-pixel channel diff below this = noise, ignored
const CANVAS_W               = 80;
const CANVAS_H               = 60;
...
export function updateInput() {
  ...
  if (_prevPixels) {
    ...
    // channel are treated as noise and ignored. Only meaningful motion registers.
    let diff = 0;
